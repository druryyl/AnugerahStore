...
(
	...
	Qty DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_Qty DEFAULT(0),
	Harga DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_Harga DEFAULT(0),
	Diskon DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_Diskon DEFAULT(0),
	TaxProsen DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_TaxProsen DEFAULT(0),
	TaxRupiah DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_TaxRupiah DEFAULT(0),
	SubTotal DECIMAL(18,2) NOT NULL CONSTRAINT DF_PurchaseDetil_SubTotal DEFAULT(0),
