...
(
	...
	TotalHarga DECIMAL(18,0) NOT NULL CONSTRAINT DF_Purchase_TotalHarga DEFAULT(0),
	Diskon DECIMAL (18,0) NOT NULL CONSTRAINT DF_Purchase_Diskon DEFAULT(0),
	BiayaLain DECIMAL (18,0) NOT NULL CONSTRAINT DF_Purchase_BiayaLain DEFAULT(0),
	GrandTotal DECIMAL (18,0) NOT NULL CONSTRAINT DF_Purchase_GrandTotal DEFAULT(0),
