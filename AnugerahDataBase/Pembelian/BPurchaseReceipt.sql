...
(
	...
	QtyPurchase DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_QtyPurchase DEFAULT(0),
	QtyReceipt DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_QtyReceipt DEFAULT(0),
	Harga DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_Harga DEFAULT(0),
	Diskon DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_Diskon DEFAULT(0),
	Tax DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_Tax DEFAULT(0),
	SubTotal DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPurchaseReceipt_SubTotal DEFAULT(0)
)
GO
