...
(
    ...
    NilaiPiutang DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPiutang_NilaiPiutang DEFAULT(0),
    NilaiLunas DECIMAL(18,2) NOT NULL CONSTRAINT DF_BPPiutang_NilaiLunas DEFAULT(0),
