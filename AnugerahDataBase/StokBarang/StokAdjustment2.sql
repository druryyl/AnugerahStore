...
(
	...
	QtyAwal DECIMAL(18,0) NOT NULL CONSTRAINT DF_StokAdjustment2_QtyAwal DEFAULT(0),
	QtyAdjust DECIMAL(18,0) NOT NULL CONSTRAINT DF_StokAdjustment2_QtyAdjust DEFAULT(0),
	QtyAkhir DECIMAL(18,0) NOT NULL CONSTRAINT DF_StokAdjustment2_QtyAkhir DEFAULT(0),
